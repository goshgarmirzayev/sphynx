...
import com.brotherhood.com.indefinite.service.inter.UserServiceInter;
...
public class UserController {
    ...
    public ModelAndView editPost(@ModelAttribute @Valid com.brotherhood.com.indefinite.bean.User user, BindingResult result) {
        if(result.hasErrors()) {
            ModelAndView mv = new ModelAndView();
